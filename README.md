...
1. Run [`scripts/01_train_vfl.py`](scripts/01_train_vfl.py) to train the split-learning models. This script exports model checkpoints required by the attack stage.
2. Run [`scripts/02_evaluate_attacks.py`](scripts/02_evaluate_attacks.py) to evaluate baseline attacks and AT-SPGD. This script exports both metric tables and saved adversarial tensors for downstream analysis.
3. Run [`scripts/03_visualize_results.py`](scripts/03_visualize_results.py) to regenerate the paper-style plots and analysis tables from the saved attack artifacts.
...
- [01_train_vfl.ipynb](./01_train_vfl.ipynb)
- [02_evaluate_attacks.ipynb](./02_evaluate_attacks.ipynb)
- [03_visualize_results.ipynb](./03_visualize_results.ipynb)
...
<p align="center"><strong><span style="font-size: 2em;">Thank you for reviewing this work ♥︎</span></strong></p>